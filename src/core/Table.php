...
use GemLibrary\Database\Query\WhereTrait;
use GemLibrary\Helper\StringHelper;

class Table extends PdoQuery {

    private int    $pagination_limit; //ok
    private string $page; //ok
    private int    $count;
    private string $find; //ok
    private string $between; //ok
    private string $orderBy;//ok
    private string $listQuery;
    private array  $listBindValues;//ok
    private string $sort;//ok
    private string $where; //ok
